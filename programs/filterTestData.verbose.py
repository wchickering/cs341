    ...
    try:
        ...
        for shownItem in query.shown_items:
            ...
            for i in range(len(query.previously_clicked_items)):
                print '*****'
                print sim.jaccard(prevQueryLists[i], shownItemQueryIds)
                print "previously clicked item"
                print query.previously_clicked_items[i]
                print prevQueryLists[i]
                print "shown item"
                print shownItem
                print shownItemQueryIds
                print "*****"
                print line,
