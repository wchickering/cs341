...
def parseArgs():
    ...
    usage = "usage: %prog "\
            ...
            + "[--num_reordered_queries_all : number of reordered queries using all indexes \
            - used to estimate percent rankable with subset of indexes if not is_all]"\
            + "<filename>"
    ...
    optionGroup.add_option("-q", "--quiet", action="store_false", dest="verbose", \
            help="quieter output")
...
def main():
    ...
    ### HARD CODES ###
    is_all = True
    test_data_purchases = 10683
    data_affectable_all = 0.3
    test_data_queries = 950120
    test_data_clicks = 327057
    test_data_purchases = 10683
    rankable_data_queries = 225356
    rankable_data_clicks = 91315
    rankable_data_purchases = 3593
    test_data_conversion = 0.032664
    test_data_front_page_conversion = 0.037326
    ...
    first_page_diff = total_reordered_clicks_front_page - total_shown_clicks_front_page
    first_page_purchase_diff = total_purchased_front_page_reordered - \
        total_purchased_front_page_orig
    percent_increase_first_page = float(first_page_diff)/total_shown_clicks_front_page
    percent_increase_total_clicks = float(first_page_diff)/test_data_clicks
    percent_increase_total_purchases = float(purch_front_reordered-purch_front_orig)/test_data_purchases
    ...
    perc_click_ratio_95 = 1.96*click_diff_std_dev / first_page_diff
    # purchases:
    ...
    perc_purchase_ratio_95 = 1.96*purchase_diff_std_dev / first_page_purchase_diff
    ...
    print 'total_recall_reordered_top_k = ', float(total_clicks_in_topK_reordered)/clicked_items
    ...
    print 'total_purchase_recall_front_orig = ', \
            float(total_purchased_front_page_orig)/clicked_items
    ...
    print 'total_purchase_recall_front_reordered = ', \
        float(total_purchased_front_page_reordered)/clicked_items
    ...
    print 'clicks:'
    print 'first_page_difference = \t\t', first_page_diff, " / ", total_shown_clicks_front_page
    #print 'click_diff_std_dev = \t\t\t', click_diff_std_dev
    print 'percent_increase_first_page = \t\t', \
        "{0:.4f}".format(float(first_page_diff)/total_shown_clicks_front_page)
