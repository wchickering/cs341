...
\begin{figure}[htbp!]
\centering
\includegraphics[width=\textwidth]{000050_0_48chunk_k100_i2_n100_percent_increase_position_score_0-0_25.eps}
...
filled with a variety of different brands and sizes of cases of
bottled water. These appear to be reasonable results for any shopper making such
a general query. Unfortunately, packs of bottled water were not what David
wanted to find.
...
similar to his interest in the water cooler stand.
...
The Session-ReRank ordering in this examples is dramatically different from the
original ordering. In Figure \ref{fig:compare_orderings}, we compare the top six
results of each ordering.
...
In the original query results, David David ended up clicking on the 90th item
presented by Walmart -- a ``3 liter Arrowhead Mountain Spring Water''. Our
technique move this item from its original position to the 3rd position in the
query results! In fact, w
