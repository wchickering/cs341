...
previously clicked items) while the remaining 70\% of queries were truncated. 
We call this set of truncated queries, $\tau$. As discussed in Section 6, 
...
queries (even those outside of $\zeta$ which re-ranker could not impact), we
