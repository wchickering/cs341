...
short. We call this set of truncated queries, $\tau$. As discussed in Section
\ref{sec:experiment}, we cannot accurately test {\em SRR} on $\tau$ since it
would have performed differently on this set of queries (FOOTNOTE).
