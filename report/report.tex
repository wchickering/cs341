...
existing query result rankings. Based on the statistically signicant improved
observed using first-page CTR $\mathscr{C}$, first-page purchase rate
$\mathscr{P}$, and {\em click-position score} $\mathscr{S}$, we believe {\em
