...
significantly outperforms Walmart’s original ordering on queries in {\chi}. As
shown in Fig. \ref{fig:compare_metric_performance}, the re-ranking achieves a
16\% increase in $\mathscr{C}$ compared to Walmart’s original ordering. The
implication is that items on the first page of the re-ranking are 16\% more
likely to be clicked than those in the original ranking. With 1M queries in our
test set {\chi}, these results are statistically significant, producing a 95\%
