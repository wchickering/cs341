...
however, that {\em SRR} can significantly improve the quality of Walmart.com's
existing query result rankings. Based on the statistically signicant
improvements observed using first-page CTR $\mathscr{C}$, first-page purchase
rate $\mathscr{P}$, and {\em click-position score} $\mathscr{S}$, we believe
{\em SRR} would be a good candidate for A/B testing.
