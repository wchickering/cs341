...
clicks on this item during his session. Sometime later he begins another query
by narrowing his search to the ``Grocery$\rightarrow$Beverages$\rightarrow$Water''
category and making a query for ``water''. Walmart has 300+ results to show
David. We compare the top six Walmart results to our Session Re-Rank results in
Figure \ref{fig:compare_orderings} where the first and third column represent
the original ranking in the Walmart search results presented to David.
\begin{figure}[htbp!]
    \centering
...
\end{figure}
Note the difference between sizes of the individual water bottles presenting in
each of the results. In Walmart's ordering, the top six items are all cases of
water with less than 1 liter in each bottle. In the Session Re-Rank ordereding,
there is a mix of large and small sizes of water bottles. In fact, both of the
Arrowhead brands would be the perfect size for the water cooler David is
interested in.
...
\begin{figure}[htbp!]
    ...
    \begin{tabular}{| c | c | c | c | c | c | c |}
        \hline
           & Clicks & Items  & Queries & Titles \\ \hline
        1  & 0.525  & 0.16   & 0.153   & 0.0294 \\ \hline
        2  & 0.686  & 0.21   & 0.239   & 0.0274 \\ \hline
        3  & 0.000  & 0.194  & 0.112   & 0.0257 \\ \hline
        4  & 0.451  & 0.198  & 0.0606  & 0.0229 \\ \hline
        5  & 0.458  & 0.147  & 0.0937  & 0.0229 \\ \hline
        6  & 0.000  & 0.0968 & 0.0422  & 0.0229 \\ \hline
    \end{tabular}
    \caption{Index similarity scores of the top six Walmart results to ``Primo
    Ceramic Crock Water Cooler with Stand''}
    \label{fig:walmart_sim_scores}
\end{figure}
