...
down by position (Fig. \ref{fig:ctr_vs_position}) shows that users of Walmart.com 
are dramatically more likely to click on items near the top, suggesting that Walmart’s 
search results are also influenced by position bias . Antoher obstacle overcome by {\em SRR} is
