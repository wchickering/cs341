...
When run on $\Chi$, {\em SRR} on average demotes 8\% of all first-page clicks,
but replaces them with even more clicks from other pages. In the worst case, we
assume that when run on $\tau$, it would demote 8\% of first-page clicks but
replace them with 0 clicks from other pages. Assuming this extremely
pessimistic lower bound for the 75\% of queries in $\zeta$ that make up $\tau$,
