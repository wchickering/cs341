...
higher likelihood of finding an item very similar to a previously clicked one.
The specifics of the scatter plot are little less clear. There is a distinct
