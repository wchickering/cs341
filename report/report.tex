...
clicks on this item during his session. Sometime later he makes another query
by navigating to the ``Grocery $\rightarrow $Beverages $\rightarrow $Water''
category and searching for ``water''. Walmart has 300+ results to show David. We
compare the top six Walmart results to our Session Re-Rank results in Table
\ref{tab:compare_orderings} where the first and third column represent the
original ranking in the Walmart search results presented to David.
\begin{table}[htbp!]
    \centering
...
\end{table}
Tables \ref{tab:walmart_sim_scores} and \ref{tab:rerank_sim_scores} show the
...
correponds to Table \ref{tab:walmart_sim_scores} and the second column is the
similarity metric from Equation (\ref{eqn:similarity_metric}) using our
optimized tuning parameters.
\begin{table}[htbp!]
    \centering
    \begin{tabular}{| c | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} |}
        \hline
          & {S} & {CTR} & {Clicks} & {Items} & {Carts} & {Queries} & {Titles}  \\ \hline
        1 & 0.943746587049 & 0.0754 & 0.00227790432802 &  0.017955801105   &  0.0 &  0.0104712041885   &  0.0909090909091 \\ \hline
        2 & 1.20210752946  & 0.0390 & 0.00389105058366 &  0.0251450676983  &  0.0 &  0.0254833040422   &  0.0833333333333 \\ \hline
        3 & 0.357056025563 & 0.0254 & 0.0              &  0.0227882037534  &  0.0 & 0.00555212831585   &  0.0769230769231 \\ \hline
        4 & 0.75268102742  & 0.0195 & 0.0016835016835  &  0.0233918128655  &  0.0 &  0.0016339869281   &  0.0666666666667 \\ \hline
        5 & 0.736731785955 & 0.0153 & 0.00173310225303 &  0.016077170418   &  0.0 &  0.00390015600624  &  0.0666666666667 \\ \hline
        6 & 0.174834647629 & 0.0129 & 0.0              &  0.00954198473282 &  0.0 &  0.000793021411578 &  0.0666666666667 \\ \hline
    \end{tabular}
    \caption{Index similarity scores of the top six Walmart results to \\ ``Primo Ceramic Crock Water Cooler with Stand''}
    \label{tab:walmart_sim_scores}
\end{table}
\begin{table}[htbp!]
    \centering
    \begin{tabular}{| c | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} | n{1}{5} |}
        ...
        1  & 0.943746587049 & 0.0754     & 0.00227790432802 &  0.017955801105 &  0.0 &  0.0104712041885 &  0.0909090909091  \\ \hline
        2  & 1.20210752946  & 0.0390     & 0.00389105058366 &  0.0251450676983 &  0.0 &  0.0254833040422 &  0.0833333333333 \\ \hline
        90 & 0.95310150677  & 0.00022623 & 0.00357142857143 &  0.027027027027 &  0.0 &  0.000920810313076 &  0.0833333333333\\ \hline
        63 & 0.949541641831 & 0.00049366 & 0.00261096605744 &  0.0338345864662 &  0.0 &  0.00385802469136 &  0.0833333333333\\ \hline
        38 & 0.93768536446  & 0.000914   & 0.00344234079174 &  0.0331384015595 &  0.0 &  0.0 &  0.0909090909091             \\ \hline
        8  & 0.896706599209 & 0.01       & 0.00355239786856 &  0.0248565965583 &  0.0 &  0.0 &  0.0666666666667             \\ \hline
    \end{tabular}
    \caption{Index similarity scores of the top six Session Re-Rank results to \\ ``Primo Ceramic Crock Water Cooler with Stand''}
    \label{tab:rerank_sim_scores}
\end{table} 

The scores from the {\em title-space} index are easily calculated by hand. We
will show the calculation for the {\em items-space} index for the 90th item in
the originl ranking here. By referring to the {\em items-space} index, we can
recall that the 90th item was clicked in the same query with 39 different items
and the previously clicked item was clicked in the same query with 455 different
items.
...
Arrowhead Mountain Spring Water, 3 l
...
Nestle Pure Life Purified Water, .5 l, 35pk
