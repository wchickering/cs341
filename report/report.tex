...
of $\chi$ than queries in general. In the red curve a discontinuity appears at
position 17 as a result of the pagebreak. This discontinuity is absent from the
blue curve due to the omission truncated results. In its place, we find local 
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\textwidth]{V=CTRcompare.png}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\textwidth]{000050_0_48chunk_k100_i2_n100_avg_click_position_score_0-0_25.png}
...
to use with the cooler he had picked up. In this case, {\em SRR}
