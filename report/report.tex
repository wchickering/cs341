...
X.X\% increase in $\mathscr{P}$, and a X.X\% increase in $\mathscr{S}$ within
our test set $\Chi$. Extrapolating these results to queries in general is
quite challenging. In the case of $\mathscr{C}$, we establish an very conservative
...
serious consideration for online A/B of {\em SRR}.
